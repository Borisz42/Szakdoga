...
% Dolgozat metaadatai
% Document's metadata
\title{Interakció fraktálokkal} % cím / title
\date{2020} % védés éve / year of defense

% Szerző metaadatai
% Author's metadata
\author{Borbély Dávid}
\degree{programtervező informatikus, BSc.}

% Témavezető(k) metaadatai
% Superivsor(s)' metadata
\supervisor{Bán Róbert} % belső témavezető neve / internal supervisor's name
\affiliation{Doktorandusz, MSc.} % belső témavezető beosztása / internal supervisor's affiliation
...
\maketitle
\topicdeclaration
%\includepdf[pages=1]{images/bejelneto.pdf}
